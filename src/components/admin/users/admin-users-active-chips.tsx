...
import type { ActiveFilterChip } from "@/lib/admin/users-display";

interface AdminUsersActiveChipsProps {
  chips: ActiveFilterChip[];
}

export function AdminUsersActiveChips({ chips }: AdminUsersActiveChipsProps) {
